...
class OnBoardingPianificaRepositoryImpl @Inject constructor(private val json : Json, private val ai : GenerativeModel  ) : OnBoardingPianificaRepository {

    override suspend fun setAreaAi(nomeAzienda: String): List<AreaLavoro> {
        return try {
    ...
    override suspend fun setTurniAi(nomeAzienda: String): List<TurnoFrequente> {
        return try {
