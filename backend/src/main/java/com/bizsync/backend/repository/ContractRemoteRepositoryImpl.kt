...
class ContractRemoteRepositoryImpl @Inject constructor(
    ...
    override suspend fun syncRecentContratti() {
        try {
    ...
    override suspend fun syncAllContratti() {
        try {
...
//            contrattoDao.clearAllContratti()
    ...
    override suspend fun generateCcnlInfo(
    ...
    override suspend fun saveContract(contratto: Contratto): Resource<String> {
        return try {
    ...
    override suspend fun getContrattoByUserAndAzienda(idDipendente: String, idAzienda: String): Resource<Contratto> {
        return try {
            val querySnapshot = db.collection(ContrattiFirestore.COLLECTION)
