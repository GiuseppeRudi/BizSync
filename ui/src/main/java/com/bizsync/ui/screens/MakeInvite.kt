...
@Composable
fun TwoStepProgressIndicator(
    currentStep: Int,
    step1Label: String = "Step 1",
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    ...
                    fontWeight = if (currentStep == 1) FontWeight.Medium else FontWeight.Normal
                )

                Text(
                    text = step2Label,
                    style = MaterialTheme.typography.bodyMedium,
                    color = if (currentStep >= 2)
                        MaterialTheme.colorScheme.primary
                    else
                        MaterialTheme.colorScheme.onSurfaceVariant.copy(alpha = 0.6f),
                    fontWeight = if (currentStep == 2) FontWeight.Medium else FontWeight.Normal
                )
            }
        }
    }
...
fun CreateInviteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Progress Bar per i due step
            TwoStepProgressIndicator(
                currentStep = currentStep,
                step1Label = "Informazioni Base",
                step2Label = "Configurazione CCNL",
